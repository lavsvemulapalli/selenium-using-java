...
public class SkyLog {
	...
	public void testLogin()throws Exception
	{
		...
		d.findElement(By.xpath("//input[@id='email']")).sendKeys("vlavanya10@gmail.com");
		String uname=d.findElement(By.xpath("//input[@id='email']")).getAttribute("value");
		//Enter password
		d.findElement(By.xpath("//input[@id='password']")).clear();
		d.findElement(By.xpath("//input[@id='password']")).sendKeys("Bharath1@");
