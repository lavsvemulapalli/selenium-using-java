...
public class SkylogPOI {
	...
	public void testLogin()throws Exception
	{
		...
		FileInputStream fsi=new FileInputStream("F:\\Testdata\\skylog1.xlsx");
		...
		for(int i=1;i<s.getLastRowNum()+1;i++)
		{
			...
			d.findElement(By.xpath("//input[@id='email']")).sendKeys(s.getRow(i).getCell(0).getStringCellValue());
			
			String uname=d.findElement(By.xpath("//input[@id='email']")).getAttribute("value");
			//Enter password
			d.findElement(By.xpath("//input[@id='password']")).clear();
			d.findElement(By.xpath("//input[@id='password']")).sendKeys(s.getRow(i).getCell(1).getStringCellValue());
